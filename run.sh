...
foreman start --formation "enroll=3, users_primary=1, users_secondary_1=1, users_secondary_2=1, krakend=1, dynamodb_local=1, notify=1, mail_server=1, email_consumer_process=3, webhook_consumer_process=3"
